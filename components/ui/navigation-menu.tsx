...
const navigationMenuTriggerStyle = cva(
  "bg-transparent hover:bg-muted group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium outline-none transition-[color,box-shadow] hover:text-accent-foreground focus:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring/30 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-accent-foreground data-[state=open]:focus:text-accent-foreground"
);
